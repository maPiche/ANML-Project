...
class Omniglot(data.Dataset):
    ...
    # Todo return sets of k characters with labels
    def kSet(self, k, rands = True):
        #for each language split modulo k, discard rest
        #add each block to a list of blocks, randomize block if rands
        #label blocks and characters.
        #return new dataset
